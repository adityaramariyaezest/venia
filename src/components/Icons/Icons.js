...
export const SearchIcon = ({ classes }) => {
    return (
        <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="20.414" height="20.414" viewBox="0 0 20.414 20.414">
...
export const ActivityIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20">
...
export const AirplayIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20">
...
export const UserIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20">
...
export const ShoppingCartIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22">
...
export const MapPinIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 20 24">
...
export const InstagramIcon = ({ classes }) => {
    return (
        <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22">
...
export const FacebookIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="13" height="22" viewBox="0 0 13 22">
...
export const TwitterIcon = ({ classes }) => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="24" height="20.142" viewBox="0 0 24 20.142">
...
export const HeartIcon = () => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="22.903" height="20.232" viewBox="0 0 22.903 20.232">
...
export const ChevronLeftIcon = () => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="8.414" height="14.828" viewBox="0 0 8.414 14.828">
...
export const EditIcon = () => {
    return (
        <svg className={icons.classes} xmlns="http://www.w3.org/2000/svg" width="22.311" height="22.121" viewBox="0 0 22.311 22.121">
